...
//    }
    ...
    public List<CompletionDTO> getAllCompletionByBookId(@PathVariable Long bookId) {
        return completionService.getAllCompletionByBookId(bookId);
    }
